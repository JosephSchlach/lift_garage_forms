...
router.post('/', (req, res) => {
    ...
    "unnecessary_parts", "test_drive_notes", "ready_for_customer", "status")
    ...
    [ checkout.date, checkout.inspection_complete, checkout.fluid_levels, checkout.tires_torqued,
        ...
        checkout.final_mileage, checkout.final_walkaround, checkout.unnecessary_parts, checkout.test_drive_notes, checkout.ready_for_customer, checkout.status ]
    )
    .then((result) => {
        res.sendStatus(201);
    })
